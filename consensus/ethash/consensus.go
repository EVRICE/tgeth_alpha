...
import (
	...
	"github.com/EVRICE/tgeth_alpha/common/math"
	"github.com/EVRICE/tgeth_alpha/common/u256"
	"github.com/EVRICE/tgeth_alpha/consensus"
	"github.com/EVRICE/tgeth_alpha/consensus/misc"
...
var (
	FrontierBlockReward           = uint256.NewInt().SetUint64(1e+18) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = uint256.NewInt().SetUint64(1e+18) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = uint256.NewInt().SetUint64(1e+18) // Block reward in wei for successfully mining a block upward from Constantinople
