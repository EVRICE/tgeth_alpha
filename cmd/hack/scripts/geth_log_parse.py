...
with open('/Users/alexeyakhunov/workspace/src/github.com/EVRICE/tgeth_alpha/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/EVRICE/tgeth_alpha/badger.csv', 'w') as w:
